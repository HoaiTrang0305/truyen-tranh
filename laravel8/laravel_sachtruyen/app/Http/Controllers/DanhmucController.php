    ...
    public function store(Request $request)
    {
        $data = $request->validate  (
            ...
            [
                ...
                'slug_danhmuc.required'=>'Thiếu slug danh mục, vui lòng nhập slug danh mục',
                'tendanhmuc.required'=>'Thiếu tên danh mục, vui lòng nhập tên danh mục',
                'mota.required'=>'Thiếu mô tả danh mục, vui lòng nhập mô tả danh mục',
            ]
         );
